          ...
          {actionCards.map((card) => {
            ...
            return (
              <Link key={card.key} to={card.path}>
                <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer h-full border-border/50 <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer h-full border-border/50 min-h-[200px] relative overflow-hidden"> relative overflow-hidden">
                  {card.key === "stations" && (
                    <img
                      src={evChargerBg}
                      alt=""
