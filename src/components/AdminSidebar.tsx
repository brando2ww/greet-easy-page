  ...
  return (
    <div className="w-[280px] h-screen bg-white border-r border-border flex flex-col py-6">
          ...
          return (
            <NavLink
              ...
              className={cn(
                ...
                active
                  ? "bg-primary/5 text-primary border-l-4 border-primary font-medium"
      ...
      <div className="px-3 pt-4 border-t border-border">
        ...
        <button
          onClick={signOut}
          className="w-full flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-all"
        >
